   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ thumbsdown: /:\-1:/g
            ...
            function run(el, replacer) {
                ...
                var elementsBlacklist = defaultConfig.blacklist.elements,
                    classesBlacklist = defaultConfig.blacklist.classes;
                ...
                if(typeof win.document.createTreeWalker !== 'undefined') {
                        ...
                        function(node) {
                            if(node.nodeType !== 1) {
                                ...
                                return win.NodeFilter.FILTER_ACCEPT;
														...
														var nTagName = node.tagName.toLowerCase(), nClassName = node.className;
                            if(elementsBlacklist.indexOf(nTagName) !== -1 || nTagName === "svg" || classesBlacklist.indexOf(nClassName) !== -1) {
                    ...
                    treeTraverse(el, function(node){
                        if(
                            (typeof node.tagName !== 'undefined' && elementsBlacklist.indexOf(node.tagName.toLowerCase()) !== -1) ||
                            (typeof node.className !== 'undefined' && classesBlacklist.indexOf(node.className.toLowerCase()) !== -1)
                        ){
                            return false;
                        }
                        if (node.nodeType === 1) {
